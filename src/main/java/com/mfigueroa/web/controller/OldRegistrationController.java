...
import com.mfigueroa.web.error.UserAlreadyExistException;
...
public class OldRegistrationController {
    ...
    public String confirmRegistration(final HttpServletRequest request, final Model model, @RequestParam final String token) {
    ...
    public String changePassword(final HttpServletRequest request, final Model model, @RequestParam final long id, @RequestParam final String token) {
        final Locale locale = request.getLocale();
    ...
    public String savePassword(final HttpServletRequest request, final Model model, @RequestParam final String password) {
        final Locale locale = request.getLocale();
